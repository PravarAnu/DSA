/*
	-----------------------------------------------------Binary Search-------------------------------------------------------------
	                       (**Binary search only used when the list of numbers are already sorted**)
	...
	Algorithm:
		...
		low -> first index of given array
		high -> last index of given array
		mid -> middle index of the given array
